...
class EntitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entity" do
    assert_difference('Entity.count') do
      post entities_url, params: { entity: { name: @entity.name, typology: @entity.typology } }
    end
  ...
  test "should update entity" do
    patch entity_url(@entity), params: { entity: { name: @entity.name, typology: @entity.typology } }
